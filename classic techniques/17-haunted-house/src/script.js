...
const tick = () =>
{
    ...
    ghost3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.25))
    ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.5))
    ghost3.position.y = (Math.sin(ghost2Angle) * 4) * (Math.sin(ghost2Angle) * 2.5)
