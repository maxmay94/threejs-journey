...
gui.add(directionalLight.position, 'y').min(-5).max(5).step(0.001).name('lightPositionY')
gui.add(directionalLight.position, 'z').min(-5).max(5).step(0.001).name('lightPositionZ')
